...
function addSleepLink(md, lnk, title, body, img, white, plc, params, txt, sty, cnt, per, wid)
{
	...
	var js = "sleepForNight(" + (plc === undefined || plc === '' ? "undefined" : plc) + "," + (bTxt ? "'" + txt + "'" : "undefined") + "," + (bParams ? "'" + params + "'" : "undefined") + (bPer ? ",'" + (typeof per == "string" ? per : per.uid) + "'" : "") + ");";
