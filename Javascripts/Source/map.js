...
var oPlaceMap = {
	// Individual places
	"2"  : { ar: [3,7,8,28,29] },
	"9"  : { ar: [10,11,27,69,70,71,72,74,75,76,144,145,234,252] },
	"16" : { ar: [14,15,17,18,20,21,65,66,67,191,192,290,296] },
	"25" : { ar: [24] },
	"26" : { ar: [34,86,247,248] },
	"45" : { ar: [40,41,46,122,156,374] },
	"52" : { ar: [53,54] },	
	"60" : { ar: [61] },
	"63" : { ar: [87] },
	...
	"370": { ar: [371,372,412,413,414,415,416,417] },
	"390": { ar: [391] },
	"400": { ar: [401,402] },
	"420": { ar: [422,423,425] },
	"435": { ar: [434] },
...
function renderBuilding(p, b, plc, clkfn)
{
	...
	return svg +
		...
		'<text font-size="0.4em" font-weight="bold" style="fill:yellow;stroke:black;stroke-width:0.3;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:0.5" x="' + b.pos.x + '" y="' + (b.pos.y + b.size.y) + '">' + sn + '</text>' +
...
function renderMap(clkfn)
{
	...
	map['Cherise_Road'].addBuilding(		432,	"Melanie's House",			"Images/house17.jpg",	{x:50, y:80/450*339}, {x:317, y:585}, 39); // width="600" height="400"
	...
	map['Park_Bridge'].addBuilding(		220,	"Zali's House",				"Images/house18.jpg",	{x:64, y:(68/640*380)}, {x:380, y:209}, 1000);// width="640" height="427"
	...
	map['Broken_Oar_Street'].addBuilding(123,	"Broken Inn Hotel",			"Images/hotel1.jpg",		{x:80, y:65}, {x:365, y:370}, 85); // width="500" height="400"
	...
	map['Yoolaroo_Drive'].addBuilding(	176,	"Robbins' House",				"Images/house1.jpg",		{x:75, y:(75/600*377)}, {x:60, y:400}, 83); // width="600" height="377"
	map['Yoolaroo_Drive'].addBuilding(	460,	"Tanika's House",				"Images/house15.jpg",	{x:65, y:(65/600*453)}, {x:55, y:455}, 15); // width="600" height="377"

	map['Dervish_Road'].addBuilding(		420,	"Bartel's House",				"Images/house2.jpg",		{x:75, y:(75/8*6)}, {x:45, y:525}, 53); //width="800" height="600"
	map['Dervish_Road'].addBuilding(		430,	"Kristin's House",			"Images/house8.jpg",		{x:(50/412*600), y:50}, {x:45, y:590}, 83);// width="600" height="412"
	...
	map['Dervish_Road'].addBuilding(		390,	"Ms.Reagan's House",			"Images/house16.jpg",	{x:60, y:40}, {x:191, y:610}, 181);
	...
	map['Amaranth_Place'].addBuilding(	451,	"Lola's House",				"Images/house11.jpg",	{x:70, y:49}, {x:765, y:440}, 260);// width="600" height="450"
	...
	map['Radio_Drive'].addBuilding(		366,	tnm + " Herald",				"Images/newspaper.jpg",	{x:62, y:42}, {x:560, y:357}, 58); //width="277" height="237"
