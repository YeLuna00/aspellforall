	...
	per.showEvent = function()
	{
		...
		if (Place == 65 || Place == 67 || Place == 278) {
			if (sType == "charmkhanother1") {
				...
				md = WritePlaceHeader();
				if (per.dress == "Loulou") this.showPerson("pol4.jpg");
			...
			if (sType == "charmkhanother2") {
				...
				md = WritePlaceHeader();
				if (per.dress == "Loulou") this.showPerson("pol5.jpg");
			...
			if (sType == "charmkhanother3") {
				...
				md = WritePlaceHeader();
				if (perYou.isMaleSex()) this.showPersonRandomRorX("pol6b", isExplicit() ? (per.dress == "Loulou" ? 2 : 3) : 1);
				else if (per.dress == "Loulou") this.showPersonRorX("pol6ga.jpg");
		...
		if (Place == 169) {
			...
			if (sType == "khanbj") {
				...
				else this.showPersonRorX(per.dress == "Loulou" ? "pol6ga.jpg" : "pol6gb.jpg");
