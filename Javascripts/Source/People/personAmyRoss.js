...
function initialiseAmyRoss()
{
	...
	per.isSMSImageDressVersion = function(id) { return id > 34; };
	...
	per.getPersonSMS = function(id) {
		...
		if (id == 31) return receiveSMS('Amy', 'Charlie tells me you were looking for me, ' + findPerson("Charlie").getHeShe() + ' was a bit odd and insistent I do not talk to you. Please, not now, it\'s difficult', 'sms2.jpg');
