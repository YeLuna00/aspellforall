...
function initialiseKateGranger()
{
	...
	per.isLover = function() { return nc === true ? this.checkFlag(22) : this.checkFlag(22) || this.getCharmedLevel() == 2; };	
	...
	per.addPersonPhoneCall = function() {
		...
		if (this.place == 1000 && this.checkFlag(24)) {
			...
			if (checkPersonFlag("MrsGranger", 16) && this.hoursCharmed("skip") >= 24 && this.checkFlag(32)) {
				...
				// Ok now
				else if (!isDay() && !this.checkFlag(39) && isCharmedBy("Charlie") && Place != 35 && Place != 177 && this.hoursCharmed("skip") >= 168) {
