	...
	per.showEvent = function()
	{
		...
		if (Place == 423) {
			...
			if (sType === "leighpooloral") {
				...
				if (clv == 4) {
					md.write(
						'<p>You order your new slave to show her obedience and devotion. Leigh looks at you, unsure what you mean, but smiles as you remove your clothing and sit down on the edge of the pool.</p>'
					);
					if (perYou.isBornMale()) {
						...
						md.write(
							...
							'<p>“Slave Leigh.” You speak firmly. You will do as you are told, and not question my orders.</p>' +
					...
					md.write(
						'<p>Finally, you address her: “Slave Leigh, go and clean up and I will meet you inside"</p>' +
						'<p>Leigh smiles and walks into the house, still completely naked...</p>'
					);
					...
					md.write(
						...
						'<p>Leigh still looks a little embarrassed, but also relieved, and quickly nods. You tell her that it\'s best if the two of you return inside now, and that you can talk later.</p>' +
						'<p>Leigh smiles and agrees before she gives you a kiss and grabs her towel and swimsuit on her way into the house, not bothering to re-dress...</p>'
					);
				}
				startQuestions();
