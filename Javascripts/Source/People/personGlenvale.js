	...
	per.showEventPopup = function()
	{
		if (Place == 1 && nFromPlace != 1 && sType === "") {
			showPopupWindow("",
				...
				'&nbsp;&nbsp;&nbsp;- Click on the mana icon in the left side bar <img draggable="false" src="UI/themes/theme1/mana.png" style="width:24px" title="Mana" alt="Mana">. This opens a quick list of all known spells. Click the one to case.<br><br>' +
