...
function initialiseTracy()
{
	...
	per.showDancing = function()
	{
		...
		if (img.indexOf("poledanceb") != -1) {
			...
			md.write(
				'<p>You see Tracy is wearing a sort of bunny-girl costume, not quite a playboy bunny and certainly not the Easter Bunny. She does an erotic dance, not really a strip-tease, she keeps the lingerie mostly on for the dance.</p>' +
