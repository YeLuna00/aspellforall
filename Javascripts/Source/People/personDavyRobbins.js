...
function initialiseDavyRobbins()
{
	...
	per.showEventDavysRoom = function() {
		...
		if (sType == "davyfuck") {
			...
			addLinkToPlace(md, "go and talk to Geraldine", 176);
	...
	per.showEvent = function()
	{
		...
		if (Place == 144 && sType == 'follow') {
			...
			md.write(
				...
				'<p>"' + perYou.getPersonName() + ', he warned me about you, to stay away from you. But I have to tell you, ' + (isCharmedBy("Kate", "Davy") ? 'they are both mine, I didn\'t lie' : 'she will be mine as well') + ' and you cannot stop me."</p>' +
	...
	per.showPersonChat = function(md)
	{
		...
		if ((Place == 176 || Place == 81) && this.whereNow() == 81 && sType === "") {
			// Either Davy's bedroom or the living room
