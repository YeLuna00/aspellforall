...
function initialiseMadison()
{
	...
	per.getPersonAddress = function(n) { return isPlaceKnown("MadisonsApartment") ? n ? 465 : 'Apartment 26, 42 Celeste Rd' : n ? 0 : ''; };	
	...
	per.whereNow = function() 
	{
		...
		if (!this.checkFlag(16) && !this.checkFlag(17)) {
			var hr = getHour();
		...
		if (Place == 45 && sType === "") {
			...
			if (sType === "" || sType === "madisonstrip") {
				...
				this.addSleepLink(md, "spend the night with Madison", "Sleeping with Madison",
					...
					this.getSuffix() == "be" ? 'bed2.jpg' : 'bed1.jpg'
				);
			}
		}
	};
