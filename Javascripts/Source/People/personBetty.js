...
function initialiseBetty()
{
	...
	per.getPossessionFace = function() { return 'betty-face' + (this.isCharmedBy() ? 'c' : 'u'); };
	...
	per.showEvent = function()
	{
		...
		if (sType == "bettytf") {
			...
			if (perYou.isMaleSex()) this.showPersonRandomRorX("home-tf", isExplicit() ? 4 : 1);
