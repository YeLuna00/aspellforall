...
function spendExperience(type)
{
	...
	if (type === undefined) {
		...
		if (isSpellKnown("Transform") && !perYou.checkFlag(30) && nShown < 3) { nShown++; addOptionLink(md, "moulding as desired", "spendExperience(10)", "bloodblock"); }
		...
		if (type == 1) {
			...
			perYou.setFlag(30);
			md.write(
				'<p><b>Moulding as Desired</b></p>' +
				'<p>After some study you learn how to better control the transform spell. Still not perfect but you will have more choice and possibilities.</p>'
			);			
...
function initialiseYou()
{
	...
	perYou.sFemaleFolderList = "Eufrat,TeenKasia,TaylorSands,Beata,Arianna,Natasha,FayeReagan,ElsaJean,DakotaSkye,AdrianaChechik,Nobody/Female";
	...
	perYou.isFuta = function(bXF) {
		...
		return this.getPersonGender() == "futa";
	};
