...
function initialiseKellie()
{
	...
	per.showEvent = function()
	{
		...
		if (sType == "charmkellie3lover") {
			...
			md.write(
				'<p>Kellie lifts her shirt to reveal some great cleavage and asks,</p>' +
				'<p>"Well thank you and a little show of thanks!"</p>' +
				'<p>You promise to talk to Miss Logan and can arrange that Kellie can sit in on your tuition sessions with her.</p>' +
				'<p>Kellie looks surprised, "I did not thing you had even noticed me, thos other mentioned your fascination of the occult and not really being interested in anyone, well maybe Kate?"</p>'
			);
		...
		if (sType == "charmkellie4lover") {
			...
			md.write(
				...
				'<p>She continues, "I really could use some get of...better at studying" and she blushes, in both embarrassment at what she almost said and in her arousal.</p>'
			);
		...
		if (sType == "charmkellie5lover") {
			...
			md.write(
				...
				'<p>You give you new charmed girlfriend? study buddy? a kiss and promise to study again with her. She re-dresses and leaves the classroom.</p>'
			);
