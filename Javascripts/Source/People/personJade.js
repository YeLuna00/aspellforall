...
function RepliesJade(nR)
{
	...
	else if (nR == 674)
	{
		addComments(
			...
			'"' + myName + ', I doubt this is possible for <b>anyone</b> and the longer they are thralls the less there might be to restore." She shakes her head and continues,</p>' +
	...
	else if (nR == 676)
	{
		addComments(
			...
			'"' + myName + ', I doubt I think it more likely you want a demonic thrall sex slave" She shakes her head and continues,</p>' +
	...
	else if (nR == 675)
	{
		addComments(
			...
			'"' + myName + ', a deal is a deal, take her whenever you want." she pauses,</p>' +
...
{
	// Jade
	perJade = addPerson("Jade", 280, "Jade", '', false, false);
	...
	per.showEvent = function()
	{
		...
		if (sType == "askjade") {
			...
			if (this.dress === "") {
				md = WritePlaceHeader();
				this.pickModel("You see two women in the room talking, both look the part of a dominatrix and either could be Jade. One of them leaves ignorng you, and the one who remains is...", "jade1", "JadeTiger", "Aiden", "black haired", "blonde", 'askjade', 'Who is Jade');
				WritePlaceFooter(md);
				return true;
			}
			...
			md.write(
				...
				'<p>The room is outfit as a stylised dungeon, a fantasy of BDSM and other gear. A woman is sitting on a chair, more sprawled than sitting, looking at you with a condescending expression. Dressed in shiny leather she scream "Dominatrix" to you, especially as you were told she is "Mistress Jade"! As you are thinking this she states bluntly,</p>' +
	...
	per.showPersonChat = function(md)
	{
		if (Place == 280 && this.checkFlag(5) && this.isHere()) {
			...
			if (this.extra[0] !== 0) {
				...
				} else addQuestionC(md, 'ask for the performance fees', "Jade", 671);
			}
			return;
		}
	...
	per.callThem = function() {
		receiveCall('', 'You decide the payment offered for dancing is too tempting and call Jade to arrange for a dancing session for yourself. Jade immediately agrees, but there is a tone to her voice, a superior smirk, that she feels this is one way she is superior to you. You grit your teeth and arrange the session for tonight');
		this.setDancer("You");
