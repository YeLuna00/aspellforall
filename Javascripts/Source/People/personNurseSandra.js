...
function initialiseNurseSandra()
{
	...
	per.getModels = function() { return "Shawna|Shawna Lenee,Paige|Paige Delight,Audrey|Audrey Bitoni"; };
	...
	per.showEventPopup = function()
	{
		...
		if (sType == "sandratransformbodypaige") {
			...
			showPopupWindow("Transformed",
				...
				'<p>You tentatively as if she is alright and she replies "Yes Boss", she is definitely still Sandra and the same person she was before',
				'dispPlace()'
			);
			return true;
		}	
		if (sType == "sandratransformbodyshawna") {
			CastTransform(1);
			this.setFlag(3);
			this.dress = "Paige";
			showPopupWindow("Transformed",
				this.addPersonString("transform.jpg", "height:max%", "right") +
				'Sandra\'s body starts to subtly change, her skin becomes paler and her hair shift to a red colour. Her face changes as if a different person is standing in front of you.<p>' +
				'<p>You tentatively as if she is alright and she replies "Yes Boss", she is definitely still Sandra and the same person she was before',
				'dispPlace()'
			);
			return true;
		...
		if (sType == "sandratransformbodyaudrey") {
			...
			showPopupWindow("Transformed",
				this.addPersonString("transform.jpg", "height:max%", "right") +
				'Sandra\'s body starts to subtly change, her skin darkens and her hair turns a strwberry blonde. Her face completely changes as if a different person is standing in front of you.<p>' +
				'<p>You tentatively as if she is alright and she replies "Yes Boss", she is definitely still Sandra and the same person she was before',
				'dispPlace()'
			);
			return true;
