...
function helpCreditsPage()
{
	...
	addModel(md, 'Nurse Sandra (Alt 1)', 'Sandra - Shawna Lenee.jpg', 'Shawna Lenee aka Shauna Leene, Shawna Lee');
	addModel(md, 'Nurse Sandra (Alt 2)', 'Sandra - Paige DDF.jpg', 'Paige Delight');
	addModel(md, 'Nurse Sandra (Alt 3)', 'Sandra - Audrey Bitoni.jpg', 'Audrey Bitoni');
	...
	md.write(
		'<tr><td style="border:solid 1px;padding-left:5px"><b>Reporter Julie</b></td><td style="border:solid 1px;padding-left:5px"><p>Julia De Lucia</p></td></tr>' +
