...
function ShowPlace450(stype)
{
	...
	if (bThrall) {
		...
		if (!perLeanne.checkFlag(13)) {
			...
			if (bLost || perLeanne.checkFlag(28)) {
				md.write(
		...
		if (bLost || perLeanne.checkFlag(28)) {
			...
			addPopupLink(md, "enough trying to save her, tell the thrall \"I am your " + perYou.getMaster() + '"', "Giving up and Accept the Rewards",
				perLeanne.addPersonString("leanne13t.jpg", "height:max%", "right") +
				...
				'<p>"I am your ' + perYou.getMaster() + ', to obey in all things!" She looks at you with her blank eyes and stars to remove her clothes and says,</p>' +
