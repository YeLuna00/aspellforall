...
function ShowPlace420(stype)
{
	...
	if (bEllieCharmed && bCarolCharmed && plcEllie == 422) perCarol.showPeopleRandom(perEllie, "carolellie1", 2, "height:max");
		...
		if (bEllieCharmed && plcEllie == 422) {
			...
			if (isVisible()) {
				md.write(
					...
					'<p>"Hello ' + perYou.getMaster() + ' what can we do to you this time?"</p>'
				);
