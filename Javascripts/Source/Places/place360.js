...
function ShowPlace360()
{
	...
	md.write(
		...
		'<p>The Aquarium is actually part of the Glenvale Museum, but it is a separate building. There are pathways connecting the aquarium and tge museum, but they also have separate access roads.</p>'
	);
