...
function ShowPlace370()
{
	...
	md.write(
		'<p>On the way to the station you pass the small office for the Glenvale Herald local newspaper. You cannot recall looking at the paper, but you have seen your mother often reading it.</p>'
	);
	
	startQuestions();

	addLinkToPlace(md, "enter the TV station", 371);
	addLinkToPlace(md, 'enter the newspaper office', 370, '', 'There is no-one in the office, you guess they are out \'reporting\' on stories. <i>not implemented</i>');
