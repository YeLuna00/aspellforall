...
function ShowPlace10()
{
	...
	if (whereItem(1) == Place) {
		...
		md.write(
			'<p>The topmost paper, <b>at the top right</b> has Mr Beasley\'s name printed in bold and it about the events of the Kurndorf cult. This paper should contain valuable details for your research to find the book. You should <b>pick it up</b> and take it somewhere to study with many <b>reference books</b></p>' +
	...
	// Books you can find
	if (!bMoniqueHere) addLinkToPlaceO(md, "examine the books in the bookcase", 27, '', '', 'passTime(true,2)');
