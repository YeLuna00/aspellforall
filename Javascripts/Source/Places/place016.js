...
function ShowPlace16()
{
	...
	md.write(
		'<p>The house is one of the oldest and most prestigious buildings of the town. ' +
		...
		'<p>There is a set of garages inside a courtyard next to the mansion proper.</p>'
	);
