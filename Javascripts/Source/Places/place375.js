...
function ShowPlace375(stype)
{
	...
	if (bDemonHere) {
		...
		if (perJesse.getDemonPath() == 150)	{
			...
			if (!perJesse.checkFlag(5)) {
				md.write(
					'<p>Jesse looks at you expectantly, her entire form almost seems to quiver in anticipation - conjuring images of a tiger about to pounce on its unsuspecting prey.' +
					'</p><p>"Do you have it?" she asks. "Give it to Us."</p>' +
