...
function ShowPlace176()
{
	...
	var bTinaAwake = perTina.isCharmedBy() && perTina.checkFlag(5) && !(perTina.isVampyre() && (isDay() || !perTina.checkFlag(6)));
	...
	else if (perGeraldine.isCharmedBy("You")) perGeraldine.showPerson(clvG == 4 ? "robbins7g.jpg" : "robbins4.jpg");	// Just Mom Charmed
	...
	if (perDavy.whereNow() == 81) perDavy.showPerson("home1-" + (perDavy.checkFlag(18) ? "bound" : "free") + ".jpg", "20%", "left");
